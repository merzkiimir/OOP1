...
Contact::Contact(): Name(""), surname(""), Name3(""), address(""), date(""), email(""){}
...
Contact::Contact(
    ...
    ): Name(Name), surname(surname), Name3(Name3), address(address), date(date), email(email), numbers(numbers) {}


Contact::Contact(const Contact &oth):
    Name(oth.Name), surname(oth.surname), Name3(oth.Name3),
     address(oth.address), date(oth.date), email(oth.email), numbers(oth.numbers){}
